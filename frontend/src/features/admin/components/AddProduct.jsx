...
export const AddProduct = () => {
    ...
    const handleAddProduct=(data)=>{
        const newProduct={...data,images:[data.image0,data.image1,data.image2,data.image3],expiry: data.expiryDate  }
            ...
            <Stack rowGap={3}>
                ...
                <Stack>
                    ...
                    <TextField type='number' {...register("stockQuantity",{required:"Stock Quantity is required"})}/>
                                    ...
                                    {/* Expiry Date field */}
                                    <Stack>
                        <Typography variant='h6' fontWeight={400} gutterBottom>Expiry Date</Typography>
                        <TextField 
                            type='date' 
