...
export const Signup = () => {
  ...
  const handleSignup = (data) => {
    const cred = { ...data, isAdmin: data.isAdmin || false }; // Set isAdmin to false if unchecked
        ...
        <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
              ...
              <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
                  <Stack rowGap={'.4rem'}>
                    ...
                    <Typography alignSelf={'flex-end'} color={'GrayText'} variant='body2'>- Shop Anything At Discounted Price</Typography>
                  </Stack>
