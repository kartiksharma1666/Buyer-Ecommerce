...
export const ProductList = () => {
    ...
    const [isChatbotOpen, setChatbotOpen] = useState(false) // State for chatbot dialog
...

    {
        ...
        <Stack mb={'3rem'}>
                ...
                <Stack rowGap={5} mt={is600?2:0}>
                    ...
                    {/* Chatbot Dialog */}
                    <Dialog open={isChatbotOpen} onClose={closeChatbot} maxWidth="sm" fullWidth>
    <DialogTitle>Chat with Us</DialogTitle>
    <DialogContent>
        <Chatbot />
    </DialogContent>
    <DialogActions>
        <Button onClick={closeChatbot} color="primary">Close</Button>
    </DialogActions>
</Dialog>
